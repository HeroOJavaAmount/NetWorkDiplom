...
##
### В текущей реализации я намеренно оставил простую архитектуру, чтобы код был обозримым.
...
3.(разгрузить Connection) Могут быть и другие методы и классы на подобии Auth, Session с полями InetAdress и например User это сессия.
4.Если добавить в класс поле Socket (или, что ещё удобнее, готовые BufferedReader и PrintWriter как в Connection),
то это становится полноценной активной сессией.
5.Не забыть про зашиты например от переброра....
~~~
