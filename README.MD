...
3.Могут быть и другие методы и классы на подобии Auth, Session с полями InetAdress и например User это сессия, 
только информационная, а не активная (не владеющая сетевым каналом).. Для этого нужен Socket.
Если добавить в класс поле Socket (или, что ещё удобнее, готовые BufferedReader и PrintWriter), то это становится полноценной активной сессией.
~~~
