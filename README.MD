...
как-то им управлять. А именно: Connection — это протокол (протокольная фаза в зависимости от потребностей), 
которая предшествует основному чату и передаётуже готового, аутентифицированного пользователя в ClientHandler.
